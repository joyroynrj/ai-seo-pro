...
class AI_SEO_Pro_Readability_Analyzer
{
    ...
    public function analyze($content)
    {
        ...
        if ($long_sentence_percentage <= 25) {
            $good[] = array(
                ...
                'message' => sprintf(__('%.1f%% of the sentences contain more than 20 words, which is less than or equal to the recommended maximum of 25%%. Good job!', 'ai-seo-pro'), $long_sentence_percentage),
            );
        } else {
            $problems[] = array(
                'title' => __('Sentence length', 'ai-seo-pro'),
                'message' => sprintf(__('%.1f%% of the sentences contain more than 20 words, which is more than the recommended maximum of 25%%. Try to shorten the sentences.', 'ai-seo-pro'), $long_sentence_percentage),
            );
        }
        ...
        if ($long_paragraphs === 0) {
            ...
            $problems[] = array(
                'title' => __('Paragraph length', 'ai-seo-pro'),
                'message' => sprintf(__('%d of the paragraphs contain more than 150 words. Shorten them!', 'ai-seo-pro'), $long_paragraphs),
            );
        }
        ...
        if ($transition_percentage >= 30) {
            $good[] = array(
                ...
                'message' => sprintf(__('%.1f%% of the sentences contain transition words, which is great!', 'ai-seo-pro'), $transition_percentage),
            );
        } elseif ($transition_percentage >= 20) {
            $problems[] = array(
                'title' => __('Transition words', 'ai-seo-pro'),
                'message' => sprintf(__('Only %.1f%% of the sentences contain transition words, which is not enough. Use more of them.', 'ai-seo-pro'), $transition_percentage),
            );
        } else {
            $problems[] = array(
                'title' => __('Transition words', 'ai-seo-pro'),
                'message' => sprintf(__('Only %.1f%% of the sentences contain transition words. This is far below the recommended 30%%. Add more to improve flow.', 'ai-seo-pro'), $transition_percentage),
            );
        }
        ...
        if ($passive_percentage <= 10) {
            $good[] = array(
                ...
                'message' => sprintf(__('%.1f%% of the sentences contain passive voice, which is below the recommended maximum of 10%%. Good job!', 'ai-seo-pro'), $passive_percentage),
            );
        } else {
            $problems[] = array(
                'title' => __('Passive voice', 'ai-seo-pro'),
                'message' => sprintf(__('%.1f%% of the sentences contain passive voice, which is more than the recommended maximum of 10%%. Try to use their active counterparts.', 'ai-seo-pro'), $passive_percentage),
            );
        }
        ...
        if ($consecutive_analysis['max_consecutive'] <= 2) {
            ...
            $problems[] = array(
                'title' => __('Consecutive sentences', 'ai-seo-pro'),
                'message' => sprintf(__('%d consecutive sentences start with the same word. Mix it up!', 'ai-seo-pro'), $consecutive_analysis['max_consecutive']),
            );
        }
        ...
        if ($complex_word_percentage <= 10) {
            $good[] = array(
                ...
                'message' => sprintf(__('%.1f%% of the words in your text are considered complex. Good job!', 'ai-seo-pro'), $complex_word_percentage),
            );
        } else {
            $problems[] = array(
                'title' => __('Word complexity', 'ai-seo-pro'),
                'message' => sprintf(__('%.1f%% of the words in your text are considered complex. Try to use simpler alternatives.', 'ai-seo-pro'), $complex_word_percentage),
            );
        }
        ...
        if ($flesch_score >= 60) {
            $good[] = array(
                ...
                'message' => sprintf(__('The copy scores %.1f in the Flesch Reading Ease test, which is considered good. Good job!', 'ai-seo-pro'), $flesch_score),
            );
        } elseif ($flesch_score >= 30) {
            $problems[] = array(
                'title' => __('Flesch Reading Ease', 'ai-seo-pro'),
                'message' => sprintf(__('The copy scores %.1f in the Flesch Reading Ease test, which is considered fairly difficult to read. Try to make shorter sentences and use simpler words.', 'ai-seo-pro'), $flesch_score),
            );
        } else {
            $problems[] = array(
                'title' => __('Flesch Reading Ease', 'ai-seo-pro'),
                'message' => sprintf(__('The copy scores %.1f in the Flesch Reading Ease test, which is considered very difficult to read. Simplify your text considerably.', 'ai-seo-pro'), $flesch_score),
            );
        }
    ...
    private function count_word_syllables($word)
    {
        ...
        if (substr($word, -2) === 'le' && $len > 2 && !in_array($word[$len - 3], $vowels)) {
            $syllables++;
        }
    ...
    private function analyze_subheading_distribution($content)
    {
        ...
        if ($long_sections > 0) {
            return array(
                'status' => 'warning',
                'message' => sprintf(__('%d section(s) of your text have more than 300 words without a subheading. Add more subheadings to break up the text.', 'ai-seo-pro'), $long_sections),
            );
        }
